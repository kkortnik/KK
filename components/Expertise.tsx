...
const Expertise: React.FC = () => {
  ...
  return (
    <section id="expertise" className="py-24 border-t border-gray-200 overflow-hidden">
      <div className="max-w-[1400px] mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-0 border-t border-l border-gray-200">
          {services.map((service, idx) => (
            <FadeInView key={idx} delay={0.1 * idx} direction="up" className="h-full">
              <div className="group h-full border-r border-b border-gray-200 p-10 hover:bg-gray-50 transition-colors duration-300">
