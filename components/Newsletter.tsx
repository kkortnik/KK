...
const Newsletter: React.FC = () => {
  return (
    <section id="newsletter" className="py-32 bg-black text-white relative overflow-hidden">
      
      {/* Background decoration */}
      <div className="absolute right-0 top-0 w-64 h-64 bg-gray-800 rounded-full blur-[100px] opacity-20"></div>
      <div className="absolute left-0 bottom-0 w-64 h-64 bg-gray-800 rounded-full blur-[100px] opacity-20"></div>
